...
export default function FloatingPlayer() {
  ...
  // Show only when radio is active (playing or buffering)
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] bg-[#060B1F]/90 backdrop-blur-xl border border-white/10 rounded-3xl p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center gap-4 max-w-sm transition-all duration-300 animate-bounce-short">
      ...
      <div className="w-12 h-12 bg-gradient-to-tr from-saphir-electric to-[#8B99FF] rounded-2xl flex items-center justify-center text-white relative overflow-hidden flex-shrink-0 shadow-lg">
        {isBuffering ? (
