...
export default function NewPodcast() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      showToast("Podcast créé avec succès !", "success");
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-3xl font-bold text-saphir-navy">Nouveau Podcast</h1>
        </div>
        <button 
      ...
      <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm space-y-8">
        <div className="space-y-4">
          ...
          <input 
            ...
            className="w-full bg-gray-50 border-none rounded-xl py-3.5 px-4 font-bold text-saphir-navy focus:ring-2 focus:ring-saphir-electric/20 animate-fade-in" 
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <input 
                type="number" 
                placeholder="Calculé automatiquement à l'upload" 
        ...
        <div className="space-y-4">
           ...
           <textarea 
             ...
             placeholder="Décrivez le contenu de ce podcast..."
